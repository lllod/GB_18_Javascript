...
const userNum = Number.parseInt(prompt('Введите положительное целое число: '))
alert(`В числе ${userNum}:
количество сотен: ${Math.floor((userNum % 1000) / 100)} 
десятков: ${Math.floor((userNum % 100) / 10)} 
единиц: ${userNum % 10}`)
