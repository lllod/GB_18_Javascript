...
const userCelsius = parseInt(prompt('Введите значение в градусах Цельсия'));
const fahrenheit = Math.round(((9 / 5) * userCelsius + 32) * 10) / 10;
alert(`Цельсий: ${userCelsius}, Фаренгейт: ${fahrenheit}`);
